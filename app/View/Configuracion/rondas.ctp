...
<table id="tabla_rondas" width="100%" style="margin-top: 20px;">
    ...
    <tbody>
        <?php foreach ($rondas as $ronda): ?>
            <tr>
                <?php
                 $rut = $ronda['Users']['rut'] . "-" . $ronda['Users']['dv'];
                 ?>
                <td class="span3"><center><?php echo $rut; ?></center></td>
                <td class="span3"><?php echo $ronda['Users']['nombre']; ?></td>
                <td class="span3"><?php echo $ronda['Users']['ap_paterno']; ?></td>
                <td class="span3"><?php echo $ronda['Users']['ap_materno']; ?></td>
